                ...
                >
                  ...
                  <div>
                    <div className="text-left md:text-right">
                      <div className="font-bold text-[20px] mb-2">Shipping Details</div>
                      <div className="flex flex-col gap-2">
                        <div>
                          <div className="font-medium text-[10px] text-[#aaa]">State</div>
                          <div className="font-medium text-[18px]">{orderHistory.state[0].toLocaleUpperCase() + orderHistory.state.slice(1)}</div>
                        </div>
                        <div>
                          <div className="font-medium text-[10px] text-[#aaa]">City</div>
                          <div className="font-medium text-[18px]">{orderHistory.city}</div>
                        </div>
                        <div>
                          <div className="font-medium text-[10px] text-[#aaa]">Address</div>
                          <div className="font-medium text-[18px]">{orderHistory.address}</div>
                        </div>
                      </div>
                    </div>
                    <div className="text-left md:text-right mt-4">
                    <div className="font-medium text-[10px] text-[#aaa]">Total</div>
                    <div className="font-bold text-[20px]">{currencySymbol}{formatCurrency(total)}</div>
                    </div>
                  </div>
                </div>
              );
