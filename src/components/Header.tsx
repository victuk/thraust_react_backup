...
export default function Header() {
  ...
  return (
    <header className="flex justify-between items-center bg-primary h-[65px] px-10 xl:px-[140px]">
      ...
      <ul
        className={`fixed  ${
          isMenuShowing
            ...
            : "hidden"
        } lg:flex lg:relative lg:flex md:justify-between lg:flex-row lg:items-center lg:m-0lg: p-0 lg:gap-4`}
        style={{ zIndex: 200 }}
      >
      ...
      <Link to="/cart" className="fixed bottom-[2rem] right-[2rem] z-[100]">
        <img
          src="/carticon.png"
          className="h-[40px] w-[40px]"
          alt="Cart Icon"
